...
const addJob = function () {
  ...
  SyncedCron.add({
    ...
    job() {
      ...
      console.log("All posts: " + Posts.find({fields: {_id: 1, status: 1, postedAt: 1, userId: 1, title: 1}}).fetch())
...
Meteor.startup(function () {
  console.log("All posts: " + Posts.find({fields: {_id: 1, status: 1, postedAt: 1, userId: 1, title: 1}}).fetch())// eslint-disable-line
  addJob();
});
